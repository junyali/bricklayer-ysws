	...
	return (
		...
		>
			<div className="flex flex-1">
				...
				<main className="backdrop-blur-xs text-black flex-1 p-8 prose-ul:list-disc prose-ul:font-medium prose-ol:list-decimal prose-ol:font-medium prose-base prose-p:font-medium prose-headings:my-1 prose-headings:font-semibold prose-a:text-blue-600 prose-a:underline hover:prose-a:text-blue-800 mx-auto sm:ml-48">
					<Content />
				</main>
			</div>
		</div>
