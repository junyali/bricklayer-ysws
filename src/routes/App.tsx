			...
			<div className="flex-grow">
				...
				<div className="w-full flex flex-grow justify-center items-center">
					<div className="max-w-7xl">
						<div className="mt-16 text-slate-950 mx-8 font-mono">
							...
							<div>
								<div className="flex flex-col lg:flex-row items-center text-center justify-center space-y-8 md:space-y-0 md:space-x-4 xl:space-x-8 py-6 text-lg sm:text-3xl font-bold whitespace-nowrap">
									<StepCard
				...
				>
					<div className="w-full px-8">
						...
						<div className="w-full max-w-7xl min-h-[80vh] mx-auto bg-white/10 backdrop-blur-sm shadow-black shadow-lg rounded-lg border-4 border-white outline outline-4 outline-neutral-800 p-8 mt-8">
							<FAQ />
						</div>
					</div>
				</div>
